...
<template>
    <div class="mini full-height clearfix">
        ...
        <div class="content full-height" v-if="!mini">
            <panel icon="wikipedia-w" ref="word" :current="dragging" v-model="word" @pin="v => {pin.word = v}"
                   @startDrag="startDrag('word')" @endDrag="endDrag('word')"></panel>
            <panel icon="book" ref="sentence" :current="dragging" v-model="sentence" @pin="v => {pin.sentence = v}"
                   @startDrag="startDrag('sentence')" @endDrag="endDrag('sentence')"></panel>
            <panel icon="tv" ref="url" :current="dragging" v-model="url" @pin="v => {pin.url = v}"
                   @startDrag="startDrag('url')" @endDrag="endDrag('url')"></panel>
        </div>
    </div>
</template>
